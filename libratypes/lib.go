...
func (obj AccountAddress) Serialize(serializer serde.Serializer) error {
	if err := serialize_array16_u8_array(obj.Value, serializer); err != nil {
		return err
	}
	return nil
}
...
func (obj ChainId) Serialize(serializer serde.Serializer) error {
	if err := serializer.SerializeU8(obj.Value); err != nil {
		return err
	}
	return nil
}
...
func (obj Ed25519PublicKey) Serialize(serializer serde.Serializer) error {
	if err := serializer.SerializeBytes(obj.Value); err != nil {
		return err
	}
	return nil
}
...
func (obj TransactionArgument__U64) Serialize(serializer serde.Serializer) error {
	serializer.SerializeVariantIndex(1)
	if err := serializer.SerializeU64(obj.Value); err != nil {
		return err
	}
	return nil
}
...
func (obj TransactionArgument__Bool) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeBool(obj.Value); err != nil {
		return err
	}
	return nil
}
...
func serialize_array16_u8_array(value []uint8, serializer serde.Serializer) error {
...
func deserialize_array16_u8_array(deserializer serde.Deserializer) ([]uint8, error) {
	var obj []uint8
	for i := range obj {
		if val, err := deserializer.DeserializeU8(); err == nil {
			obj[i] = val
