...
func TestMultiEd25519PublicKey(t *testing.T) {
	...
	pk := diemkeys.NewMultiEd25519PublicKey(publicKeys, byte(2))
...
func TestMultiEd25519PrivateKey(t *testing.T) {
	...
	pk := diemkeys.NewMultiEd25519PrivateKey(privateKeys, byte(2))
...
func TestNewMultiEd25519PrivateKeyErrors(t *testing.T) {
	t.Run("empty keys", func(t *testing.T) {
		...
		diemkeys.NewMultiEd25519PrivateKey(nil, 0)
	})
	t.Run("threshold > len(keys)", func(t *testing.T) {
		...
		diemkeys.NewMultiEd25519PrivateKey([]ed25519.PrivateKey{privateKey}, 2)
	})
	t.Run("len(keys) > max num of keys", func(t *testing.T) {
		...
		keys := make([]ed25519.PrivateKey, diemkeys.MaxNumOfKeys+1)
		diemkeys.NewMultiEd25519PrivateKey(keys, 2)
	})
}
...
func TestNewMultiEd25519PublicKeyErrors(t *testing.T) {
	t.Run("empty keys", func(t *testing.T) {
		...
		diemkeys.NewMultiEd25519PublicKey(nil, 0)
	})
	t.Run("threshold > len(keys)", func(t *testing.T) {
		...
		diemkeys.NewMultiEd25519PublicKey([]ed25519.PublicKey{publicKey}, 2)
	})
	t.Run("len(keys) > max num of keys", func(t *testing.T) {
		defer func() {
			if r := recover(); r != nil {
		...
		keys := make([]ed25519.PublicKey, diemkeys.MaxNumOfKeys+1)
		diemkeys.NewMultiEd25519PublicKey(keys, 2)
	})
}
